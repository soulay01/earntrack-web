...
export default function EstimatesPage() {
  const { user, loading, employees, customers, companyId } = useData();
        ...
        <div className="px-8 py-8 max-w-4xl mx-auto space-y-8">
          ...
          <div className="flex items-center justify-between animate-fadeIn">
            ...
            <button onClick={handleShowPreview}
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-700 hover:to-emerald-700 hover:shadow-xl hover:shadow-teal-200/50 active:scale-[0.97] text-white font-bold rounded-xl transition-all text-sm shadow-lg">
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
              Vorschau
            </button>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden animate-slideUp">
            ...
            <div className="p-6 space-y-4">
              ...
              <button onClick={handleShowPreview}
                className="w-full py-3 bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-700 hover:to-emerald-700 hover:shadow-xl hover:shadow-teal-200/50 active:scale-[0.97] text-white font-black rounded-xl transition-all text-sm shadow-lg">
                Vorschau &amp; Export
              </button>
            </div>
          </div>
