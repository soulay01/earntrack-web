...
export default function ExportPage() {
  ...
  function exportAssignmentsCSV() {
    ...
    assignments.forEach(a => {
      const rev = calculateAssignmentFinances(a, overheadPercent).revenue;
  ...
  function exportAssignmentsHTML() {
    const rows = assignments.map(a => {
      const { revenue: rev, hours: h, rate, cost, profit } = calculateAssignmentFinances(a, overheadPercent);
