          ...
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden animate-slideUp">
            <div className="px-6 py-5 bg-gradient-to-r from-teal-600 to-emerald-600 text-white">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-teal-100">Aktueller Plan</p>
                  <p className="text-2xl font-bold mt-1">{plan.name}</p>
                </div>
                <div className="text-right">
                  <p className="text-3xl font-black">{plan.price}</p>
                  <p className="text-sm text-teal-100">pro {plan.interval}</p>
                </div>
              </div>
            </div>
            <div className="p-6 space-y-4">
              <div className="flex items-center gap-3 p-3 rounded-lg bg-green-50 border border-green-200">
                ...
                <span className="text-sm font-medium text-green-800">Aktiv &middot; Nächste Abrechnung: {plan.nextBilling}</span>
              </div>

              <div className="border-t border-slate-100 pt-4">
                <p className="text-sm font-semibold text-slate-700 mb-3">Enthaltene Funktionen</p>
              ...
              <div className="border-t border-slate-100 pt-4">
                ...
                <a href="mailto:support@earntrack.app"
                  className="inline-flex items-center gap-2 px-4 py-2.5 bg-teal-50 text-teal-700 border border-teal-200 rounded-lg text-sm font-medium hover:bg-teal-100 transition-all">
